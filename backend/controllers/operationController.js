...
const updateOperation = async (req, res) => {
  try {
    ...
    if (personalMobile !== undefined) operation.personalMobile = personalMobile;
    if (companyMobile !== undefined) operation.companyMobile = companyMobile;
    if (referenceMobile !== undefined) operation.referenceMobile = referenceMobile;
    if (companyEmail !== undefined) operation.companyEmail = companyEmail;
    if (dateOfBirth !== undefined) operation.dateOfBirth = dateOfBirth;
    if (aadharCard !== undefined) operation.aadharCard = aadharCard;
    if (panCard !== undefined) operation.panCard = panCard;
    if (joinedThrough !== undefined) operation.joinedThrough = joinedThrough;
    if (personalEmail !== undefined) operation.personalEmail = personalEmail;
