...
const operationSchema = new mongoose.Schema({
  ...
  // Operation Notifications and Settings
  notifications: { type: Boolean, default: false },
  receivedForDrafting: { type: Boolean, default: false },
  paymentReceiptReceived: { type: Boolean, default: false },
  requestForFilling: { type: Boolean, default: false },
  clientUpdation: { type: Boolean, default: false },
  leads: { type: Boolean, default: false },
  completeLead: { type: Boolean, default: false },
  dataUpdationNotify: { type: Boolean, default: false },
  chat: { type: Boolean, default: false },
  leadEditOption: { type: Boolean, default: false },
  upload: { type: Boolean, default: false },
  draft: { type: Boolean, default: false },
  poa: { type: Boolean, default: false },
  ua: { type: Boolean, default: false },
