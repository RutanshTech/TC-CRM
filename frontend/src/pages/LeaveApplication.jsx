...
const LeaveApplication = ({ sidebarCollapsed }) => {
  ...
  const fetchLeaveHistory = useCallback(async () => {
    try {
      ...
      const response = await axios.get(
        `tc-crm.vercel.app/api/employees/${userData.employeeId}/leaves`,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        `tc-crm.vercel.app/api/employees/${user.employeeId}/leave`,
        formData,
  ...
  const handleCancelLeave = async (leaveId) => {
    ...
    try {
      ...
      await axios.delete(
        `tc-crm.vercel.app/api/employees/${user.employeeId}/leave/${leaveId}`,
        { headers: { Authorization: `Bearer ${token}` } }
      );
