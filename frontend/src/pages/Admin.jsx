      ...
      <div className={`pt-16 transition-all duration-300 ${sidebarCollapsed ? "ml-12" : "ml-48"}`}>
        <div className="p-4 max-w-6xl mx-auto">
          <div className="flex justify-between items-center mb-4">
            <div>
              <h1 className="text-2xl font-bold text-gray-800">Super Admin - Admin Management</h1>
              <p className="text-sm text-gray-600 mt-1">Create and manage system admins with comprehensive onboarding</p>
            </div>
            <button
            ...
            <div className="overflow-x-auto">
              <table className="min-w-[800px] w-full divide-y divide-gray-200">
                <thead className="bg-gray-50">
                  <tr>
                    <th className="px-3 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Admin ID</th>
                  ...
                  {admins.map((admin) => (
                    ...
                    >
                      <td className="px-3 py-3 whitespace-nowrap">
                        <div className="text-sm font-medium text-gray-900">{admin.adminId}</div>
                      </td>
                      <td className="px-3 py-3 whitespace-nowrap">
                      ...
                      <td className="px-3 py-3 whitespace-nowrap">
                        <div className="text-sm text-gray-900 font-mono">{admin.plainPassword || "N/A"}</div>
                      </td>
                      <td className="px-3 py-3 whitespace-nowrap">
                        <div className="text-sm text-gray-900">{admin.personalMobile || admin.companyMobile}</div>
                      </td>
                      <td className="px-3 py-3 whitespace-nowrap">
                      ...
                      <td className="px-3 py-3 whitespace-nowrap text-sm font-medium" onClick={(e) => e.stopPropagation()}>
                        <div className="flex items-center space-x-2">
                          <button
                            ...
                            className="inline-flex items-center px-2 py-1 text-xs font-medium text-blue-700 bg-blue-100 border border-blue-200 rounded-md hover:bg-blue-200 hover:text-blue-800 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-1"
                          >
                          ...
                          <button
                            ...
                            className="inline-flex items-center px-2 py-1 text-xs font-medium text-green-700 bg-green-100 border border-green-200 rounded-md hover:bg-green-200 hover:text-green-800 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-1"
                          >
                            <svg className="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          ...
                          <button
                            ...
                            className="inline-flex items-center px-2 py-1 text-xs font-medium text-purple-700 bg-purple-100 border border-purple-200 rounded-md hover:bg-purple-200 hover:text-purple-800 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-1"
                          >
                            <svg className="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          ...
                          <button
                            ...
                            className="inline-flex items-center px-2 py-1 text-xs font-medium text-red-700 bg-red-100 border border-red-200 rounded-md hover:bg-red-200 hover:text-red-800 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-1"
                          >
                            <svg className="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <>
                    ...
                    <div className="md:col-span-2 grid grid-cols-2 md:grid-cols-3 gap-4">
                      ...
                      <div className="flex items-center">
                        <input
                          type="checkbox"
                          name="adminAccess.sales"
                          checked={formData.adminAccess.sales}
                          onChange={handleInputChange}
                          className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                        />
                        <label className="ml-2 text-sm text-gray-700">Sales</label>
                      </div>
                      ...
                      <div className="flex items-center">
                        <input
                          type="checkbox"
                          name="adminAccess.allThings"
                          checked={formData.adminAccess.allThings}
                          onChange={handleInputChange}
                          className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                        />
                        <label className="ml-2 text-sm text-gray-700">All Things</label>
                      </div>
                    </div>
                  </>
                )}
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center">
                  <input
                    type="checkbox"
                    name="sales"
                    checked={permissionsData.sales}
                    onChange={handlePermissionsChange}
                    className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                  />
                  <label className="ml-3 text-sm font-medium text-gray-700">Sales Management</label>
                </div>
                ...
                <div className="border-t border-gray-200 pt-4">
                  <div className="flex items-center">
                    <input
                      type="checkbox"
                      name="allThings"
                      checked={permissionsData.allThings}
                      onChange={handlePermissionsChange}
                      className="h-4 w-4 text-purple-600 focus:ring-purple-500 border-gray-300 rounded"
                    />
                    <label className="ml-3 text-sm font-medium text-purple-700">All Permissions (Super Admin Access)</label>
                  </div>
                  <p className="text-xs text-gray-500 mt-1 ml-7">Grants access to all features and overrides individual permissions</p>
                </div>
              </div>
