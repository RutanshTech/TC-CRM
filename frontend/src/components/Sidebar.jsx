import { LayoutDashboard, Users, Settings, LogOut, ChevronLeft, ChevronRight, Shield, DollarSign, Calendar, CreditCard } from "lucide-react";
  ...
  const getNavLinks = () => {
    ...
    if (currentUser && currentUser.role === 'operation') {
      return [
        ...
        { to: "/operations-leads", icon: <Users />, label: "Leads" },
        { to: "/operations-total-leads", icon: <Users />, label: "Total Leads" },
      ];
    }
